...
class BaseOptions(object):
    """ Base IDGAN options common to all parameter configurations. """
    ...
    def __init__(self):
        ...
        # Applies when model is accessed from a script/ on a remote cluster
            ...
            self.root_dir = cwd
            self.local_dir = os.path.join(cwd, 'IDGAN/src')
        ...
        # Discriminator(s)
        self.disc_hidden_list = [self.enc_hidden_dims * self.enc_num_layers, 256, 128, 1]
